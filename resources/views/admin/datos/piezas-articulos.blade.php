                            ...
                            <tbody id="tablabody">
                                @foreach ($piezas as $pieza)
                                    <tr>
                                        ...
                                        <td><button type="button" onclick="modificarP('{{ $pieza->id }}');"
                                                class="btn btn-info"> Modificar</button> <button type="button"
                                                onclick="eliminarP('{{ $pieza->id }}');"
                                ...
                                @foreach ($conjuntos as $conjunto)
                                    <tr>
                                        ...
                                        <td><button onclick="modificarC('{{ $conjunto->id }}');" type="button"
                                                class="btn btn-info"> Modificar</button> <button type="button"
                                                onclick="eliminarC('{{ $conjunto->id }}');"
                                                class="btn btn-danger">Eliminar</button></td>
                                    </tr>
                                @endforeach
                            </tbody>
