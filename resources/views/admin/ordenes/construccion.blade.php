...
<div class="card card-primary">
    ...
    <form id="formulario" method="POST" action="">
        ...
        <div class="card-body">
            <div class="container">
                <div class="row mb-2">
                    ...
                    <select class="col mr-2 select2" name="piezas" id="piezas">
                ...
                <div class="row mb-2">
                    ...
                    <input type="number" class="form-control col mr-2" min="0" value="0" id="cantidad-realizar" name="cantidad-realizar">
            ...
            <div class="container">
                ...
                <div class="row mb-2">
                    ...
                    <input type="number" class="form-control col mr-2" id="cantidad-necesaria" name="cantidad-necesaria" readonly>
                </div>
        ...
        <button type="button" class="btn btn-primary ml-2 mb-2" id="continuar" name="continuar" onclick="validar();">Continuar</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formulario-modal">
                        @csrf
                        <div class="row mb-2">
                            <input type="text" class="form-control col mr-2" id="buscarmaterial" name="buscarmaterial" placeholder="Ingrese el codigo del material a buscar">
                            ...
                            <table class=" table-striped table table-bordered table-scroll1">
                                ...
                                <tbody id="tbodymodal">
                                    <tr>
                                        ...
                                        <td>Materiales</td>
                                        <td><button type="button" class="btn btn-info" data-dismiss="modal" onclick="agregarMaterial('{{ $material->CodigoMaterial }}');">Agregar</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <table class="table table-bordered table-striped">
                            <tbody id="tablamodaltareas">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" placeholder="03:45" id="horaminuto" name="horaminuto" minlength="5" maxlength="5" size="5"></td>
    ...
    <div id="modalmodificartareas" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                        ...
                        <table class="table table-bordered table-striped">
                            <tbody id="tablamodalmodificartareas">
                                ...
                                <tr>
                                    ...
                                    <td> <select class=" col mr-2" name="supervisor-modificar" id="supervisor-modificar">
                                        </select></td>
                                </tr>
                                <tr>
                                    <td><label for="tiempo-agregartarea">Tiempo estimado de la tarea</label></td>
                                    <td><input type="text" placeholder="03:45" id="modificarhoraminuto" name="modificarhoraminuto" minlength="5" maxlength="5" size="5"></td>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-dismiss="modal" id="idbtnModificarTarea">Modificar</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                </div>
            </div>
        </div>
